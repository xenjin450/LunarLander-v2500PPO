...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="PPO-LunarLanderV2Advanced1",
    ...
    parser.add_argument("--repo-id", type=str, default="xenjin450/PPO-LunarLanderV2Advanced1", help="id of the model repository from the Hugging Face Hub {username/repo_name}")
